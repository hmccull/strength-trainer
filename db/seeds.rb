...
w5 = Workout.create!(name: "Didn't have fun", duration: 79, active_calories: 398, body_weight: 125, date: DateTime.new(2022, 3, 5), user_id: u1.id)
w8 = Workout.create!(name: "Deads Deload", duration: 81, active_calories: 248, body_weight: 123, date: DateTime.new(2022, 3, 6), user_id: u1.id)
w7 = Workout.create!(name: "Shoulder Deload", duration: 81, active_calories: 212, body_weight: 124, date: DateTime.new(2022, 3, 7), user_id: u1.id)
w6 = Workout.create!(name: "Ate a lot of bad food", duration: 82, active_calories: 450, body_weight: 128, date: DateTime.new(2022, 3, 8), user_id: u1.id)
